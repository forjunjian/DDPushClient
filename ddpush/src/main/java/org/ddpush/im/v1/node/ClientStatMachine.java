...
public class ClientStatMachine {
	...
	public static ClientStatMachine newFromFile(long lastTick, boolean hasMessage0x10, long last0x10Time, long message0x11, long last0x11Time, int message0x20Len, long
		last0x20Time, byte[] message0x20) {
		ClientStatMachine csm = new ClientStatMachine();
